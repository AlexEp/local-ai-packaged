...
REM ############################################################################
REM #
REM # Installation script for the Self-hosted AI Package with NVIDIA GPU support
REM #
REM ############################################################################

echo.
echo  Ahoy, matey! This script will help ye install the Self-hosted AI Package.
...
%PYTHON_CMD% start_services.py --profile gpu-nvidia
